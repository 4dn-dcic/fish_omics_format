## 4DN FISH Omics Format (FOF) - Chromatin Tracing (CT)
...
The image below gives a schematic view of the tables and their required (black), recommended , optional or conditionally required content.

...
#. Select the templates for the tables to be utilized and save them locally in CSV or in one of the other allowable tabular formats.
  ...
  - For **FOF-bas-CT** download the template for the :ref:`core` and any other of the **11 supplementary** :ref:`BAS-table-reference-label` you might need for your deposition.

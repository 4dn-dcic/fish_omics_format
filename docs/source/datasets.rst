...
4DN Data Portal
---------------
A collection of `Chromatin Tracing datasets <https://data.4dnucleome.org/resources/data-collections/chromatin-tracing-datasets>`_ compliant with the FISH-Omics Format - Chromatin Tracing (FOF-CT) are available on the 4DN-Data Portal and were curated by the 4DN `Data Coordination and Integration Center (DCIC) team <https://data.4dnucleome.org/help/about/about-dcic>`_

Open Microscopy Environment Image Data Resource (OME-IDR)
---------------------------------------------------------
Multiplexed FISH results data sets presented in the FOF-CT format are also available on the `OME-IDR <https://idr.openmicroscopy.org/>`_

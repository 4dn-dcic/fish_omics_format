...
It is **highly recommended** that all depositions contain *X_Loc_Precision*, *Y_Loc_Precision*, *Z_Loc_Precision*, and *Photon_Count* columns. Other columns can be included at the user's discretion. 
...
The following columns are **highly recommended**: ``X_Loc_Precision``, ``Y_Loc_Precision``, ``Z_Loc_Precision``, and ``Photon_Count``.

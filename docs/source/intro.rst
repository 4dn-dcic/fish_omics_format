...
The FISH Omics Format for Chromatin Tracing (FOF-CT) was initially developed in the context of the (`4D Nucleome <https://www.4dnucleome.org/>`_) project, whose mandate was to produce and promote the reuse of datasets that measure the spatial arrangement of DNA, RNA, and proteins within the human cell nucleus, thereby uncovering the functional dynamics of the genome in three dimensions and over time (referred to as 4D). 

However, FOF-CT aims to serve the community well beyond 4D Nucleome as testified by the fact that many datasets released in this format were produced by laboratories that did not participate in the 4D Nucleome consortium. We encourage broad adoption of, and contribution to, the format by the entire community.
...
Similarly, FOF-vol-CT is compatible with **volumetric** chromatin tracing methods, such as OligoSTORM and OligoDNA-PAINT 
